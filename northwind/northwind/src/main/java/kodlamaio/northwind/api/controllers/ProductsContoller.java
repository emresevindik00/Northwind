...
public class ProductsContoller {
	...
	public DataResult<List<Product>> getByProductNameContains(@RequestParam String produtcName){
		return this.productService.getByProductNameContains(produtcName);
	}
